...
class convert_lang {
    public function convert_lang_function($lang,$keyword){
        $language=array();
        $language['EN']['Remove_title']                           = remove_slash_quotes("Remove Price List Title");
        $language['EN']['Select_Language']                        = remove_slash_quotes("Select Dashboard Language");
        $language['EN']['Select_Column']                          = remove_slash_quotes("Columns");
        $language['EN']['Max_Width']                              = remove_slash_quotes("Price List Max-Width");
        ...
        $language['EN']['Change_All_word_for_Categories']         = remove_slash_quotes('Change "All" Word for Category Tab');
        $language['EN']['different_languages']                    = remove_slash_quotes("different languages");
        $language['EN']['Display_the_All_word']                   = remove_slash_quotes('Display the "All" Category Tab?');
        $language['EN']['Category_Separator_Symbol']              = remove_slash_quotes("Category Separator Symbol");
        $language['EN']['Stylish_Category_Tabs_Buttons']          = remove_slash_quotes("Stylish Category Tabs");
        $language['EN']['Open_Buy_Btn_Link_In_New_Tab']          = remove_slash_quotes("Open Buy Button Links in New Tab");
        $language['EN']['Add_Search_Bar']                         = remove_slash_quotes("Enable Filter & Search Box");
        $language['EN']['Break_title_of_Service']                 = remove_slash_quotes("Break Title of Service");
        $language['EN']['Break_line_of_categories_on_Desktop']    = remove_slash_quotes("Break Line of Categories on Desktops");
        ...
        $language['EN']['Category_description_Tabs']              = remove_slash_quotes("Category Description");
        $language['EN']['Service_Name']                           = remove_slash_quotes("Item Name");
        $language['EN']['Service_Regular_Price']                  = remove_slash_quotes("Regular Price");
        $language['EN']['Service_Long_Description']               = remove_slash_quotes("Long Description");
        ...
        $language['EN']['Service_Image']                          = remove_slash_quotes("Product/Service Image");
        //Spanish
        ...
        $language['SP']['Open_Buy_Btn_Link_In_New_Tab']          = remove_slash_quotes("Open Buy Button Links in New Tab");
        $language['SP']['Add_Search_Bar']                         = remove_slash_quotes("Enable Search Box");
        ...
        $language['SP']['Service_Long_Description']               = remove_slash_quotes("Long Description");
        $language['SP']['Service_Price']                          = remove_slash_quotes("Precio");
        ...
        $language['FR']['Open_Buy_Btn_Link_In_New_Tab']          = remove_slash_quotes("Open Buy Button Links in New Tab");
        $language['FR']['Add_Search_Bar']                         = remove_slash_quotes("Enable Search Box");
        ...
        $language['FR']['Service_Long_Description']               = remove_slash_quotes("Long Description");
        ...
        $language['DE']['Open_Buy_Btn_Link_In_New_Tab']          = remove_slash_quotes("Open Buy Button Links in New Tab");
        $language['DE']['Add_Search_Bar']                         = remove_slash_quotes("Enable Search Box");
        ...
        $language['DE']['Service_Long_Description']               = remove_slash_quotes("Long Description");
