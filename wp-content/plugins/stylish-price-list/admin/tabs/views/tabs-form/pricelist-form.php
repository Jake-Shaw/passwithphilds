...
wp_enqueue_style('spl-jquery-ui', SPL_URL . 'assets/css/jquery-ui.css', [], '1.1');
$id='';
if(isset($_GET['id'])){
    $id=$_GET['id'];
}
...
if(isset($_REQUEST['lang'])){
    ...
    $GLOBALS['Service_Long_Description'] = $lang_obj->convert_lang_function($_REQUEST['lang'],'Service_Long_Description');
...
if(!function_exists('service_item')){
    function service_item($item){
        ...
        */
        ...
        ?>
        <div class="df-spl-row service-price-length <?php if($id == 'service_regular_price' || $id == 'service_image'){ echo 'spl_service_image_element'; } ?>">
            ...
            <?php }elseif ($id == 'service_long_description') { ?>
                <textarea name="<?php echo $name; ?>" id="<?php echo $html_id; ?>" class="form-control <?php echo $id; ?>" rows="5" cols="33"><?php echo $value; ?></textarea>
            <?php } else{ ?>
                ...
                <nav class="navbar navbar-secondary df-spl-edit-nav"> <!-- Start of Price List Title, Style, Save Button-->
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav edit-page-nav navbar-right">
                            <li style="margin-right:30px;"><a name="add_to_webpage" value="" class="add_to_webpage"><i class="fa fa-desktop" aria-hidden="true" style="font-size:20px;padding-right:10px;vertical-align:middle;"></i> <?php echo $ADD_TO_WEBPAGE; ?></a></li>
                            <li style="margin-right:30px;"><a name="load_template" value="" class="advance_setting"><i class="fa fa-cog" aria-hidden="true" style="font-size:20px;padding-right:10px;vertical-align:middle;"></i><?php echo $More_Settings; ?></a></li>
                            <li style="margin-right:30px;"><a name="font_settitng" value="" class="font_settitng"><i class="fa fa-text-height" aria-hidden="true" style="font-size:20px;padding-right:10px;vertical-align:middle;"></i><?php echo $FONT_SETTINGS; ?></a></li>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><!-- START of Columns Settings Category-->
    ...
    <div class="df-spl-row cats-row more_setting">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
            ...
            <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/one-two-columns.png'; ?>"></i>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 no-pa">
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><!-- START of Category (Tab) Settings Category-->
    ...
    <div class="df-spl-row cats-row more_setting">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
            ...
            <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/all-wording.png'; ?>"></i>
        </div>
        <?php
    ...
    <div class="df-spl-row more_setting">
     ...
     <div class="df-spl-row cats-row more_setting">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
            ...
            <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/remove-all-tab.png'; ?>"></i>
        </div>
  ...
  <div class="df-spl-row cats-row more_setting">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
        ...
        <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/styled-category.png'; ?>"></i>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 no-pa">
      <?php
...
<div class="df-spl-row cats-row more_setting">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
        ...
        <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/category-separator.png'; ?>"></i>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
      <?php
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><!-- START of Title Settings Category-->
        ...
        <div class="df-spl-row cats-row more_setting">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
                ...
                <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/title-switch.png'; ?>"></i>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                <?php
                $spl_remove_title= isset($cats_data['spl_remove_title']) ? $cats_data['spl_remove_title'] : '';
        ...
        <div class="df-spl-row cats-row more_setting">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
                ...
                <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/break-line.png'; ?>"></i>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                <?php
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><!-- START of Search & Filter Settings Category-->
    ...
    <div class="df-spl-row cats-row more_setting">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 lbl">
            ...
            <i class="fa fa-eye" data-image-tooltip="<?php echo SPL_URL.'assets/images/tooltip-images/search-box.png'; ?>"></i>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
          <?php
...
<div style="max-width:900px;margin-left:0px;">
    ...
    <?php if(false): ?>
        ...
        <div class="category-rows-master-cls">
            ...
            <div class="spl-preview" style="float: left; min-width: 800px;">
