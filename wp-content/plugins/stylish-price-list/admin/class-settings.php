...
// }
    ...
    <script>
        function handleLicenseActivation(event, $form) {
            ...
            function doSubmitLicense() {
                ...
                if (event.submitter) {
                    XHR.open( "POST", "<?php echo admin_url("options.php"); ?>" );
    ...
    <form action="options.php" method="post" onsubmit="handleLicenseActivation(event, this)" id="stylishpl-admin-options-form">
