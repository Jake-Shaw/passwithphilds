...
function spl_shortcode_pricelist($atts, $content = null) {
    ...
    // wp_enqueue_style('spl-tom-select');
    // wp_enqueue_script('spl-tom-select');
    ob_start();
...
function spl_js_css_enqueue_scripts($hook) {
    ...
    wp_register_style('spl-list-style', SPL_URL . 'assets/css/frontend-style.css', array(), STYLISH_PRICE_LIST_VERSION );
...
//    wp_register_style('spl-list-style', SPL_URL . 'assets/css/frontend-style.css');
    wp_register_style('font-awwsone', SPL_URL . 'assets/font-awesome/css/font-awesome.min.css', array(), STYLISH_PRICE_LIST_VERSION);
    wp_register_script('spl-pricelist-tabs', SPL_URL . 'assets/js/tabs.js', array('jquery'), STYLISH_PRICE_LIST_VERSION , true);
}
...

{
    ...
    wp_enqueue_style( 'spl-list-style', SPL_URL . 'assets/css/frontend-style.css', array(), STYLISH_PRICE_LIST_VERSION );
    wp_enqueue_style('spl-admin-style', SPL_URL . 'assets/css/admin-style.css', array(), STYLISH_PRICE_LIST_VERSION );
    wp_enqueue_style('spl-sweetalert', SPL_URL . 'assets/css/sweetalert2.min.css', array(), STYLISH_PRICE_LIST_VERSION );
    wp_enqueue_script('spl-sweetalert', SPL_URL . 'assets/js/sweetalert2.all.js', array(), STYLISH_PRICE_LIST_VERSION );
    wp_register_script('spl-tom-select', SPL_URL . 'assets/js/tom-select.base.min.js', array(), STYLISH_PRICE_LIST_VERSION , true);
    wp_register_style('spl-tom-select', SPL_URL . 'assets/css/tom-select.bootstrap3.min.css', array(), STYLISH_PRICE_LIST_VERSION , true);
	}
}
