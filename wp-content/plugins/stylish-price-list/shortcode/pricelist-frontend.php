...
if(!empty($id)){
    ...
    foreach ($opt_cats as $cat_id => $cat) {
        ...
        foreach ($cat as $service_id => $service) {
            ...
            $services[$service_id]['service_long_description']=   remove_slash_quotes(isset($service['service_long_description']) ? $service['service_long_description'] : '');
        }
...
if(!function_exists('output_tab_contents_style8')){
    function output_tab_contents_style8($cats, $default, $shortcode_id, $select_column, $is_buy_btn_newtab_enabled){
        ...
        ?>
            ...
            ?>
            <div class="tab style-8-cards <?php if($select_column == "Two") echo "is-two-column "; echo $act_tab; ?>" id="<?php echo 'all_'.$shortcode_id; ?>" style="<?php echo $style_act;?>">
            <?php foreach ($all_services as $key => $service){
...
<?php foreach ($cats as $key => $cat): ?>
    ...
    ?>
    <div class="tab style-8-cards <?php if($select_column == "Two") echo "is-two-column "; echo $act_tab; ?>" id="<?php echo $key.'_'.$shortcode_id; ?>" style="<?php echo $style_act;?>">
       <?php if($cat['description']!=''){
           ?>
...
if(!function_exists('output_tab_contents_style6_two_column')){
    function output_tab_contents_style6_two_column($cats, $default, $shortcode_id, $is_buy_btn_newtab_enabled = 0) {
...
<?php foreach ($cats as $key => $cat): ?>
  ...
  <div class="df-spl-row">
      ...
      $j=0; ?>
      <?php foreach ($services as $key => $service){
        echo array_key_exists($i, $services) ? output_service_style6_two_column($services[$j], $is_buy_btn_newtab_enabled) : false;
        $j = $j + 2;
    }
    ?>
</div>
...
if(!function_exists('output_service_style8')){
    ...
    <div class="style-8-card clearfix">
        ...
        <div class="style-8-card-content">
            ...
            <p class="style-8-description"><?php echo $service_long_description; ?></p>
        </div>
    </div>
<?php
$html=ob_get_clean();
...
if($style=='with_tab' || $style=='' || $style == 'style_6'){ ?>
    <div class="body-inner container-fluid price_wrapper df-spl-pull-left col-md-12 spl_main_content_box" id="spl_<?php echo $id; ?>" data-style="<?php echo $style; ?>" style="max-width:<?php echo isset($max_width) ? $max_width : ''; ?>;margin-left:auto;margin-right:auto; ">
        <?php if (!empty($service['service_button'])) { ?>
...
<?php }
if($style=='style_5'){ ?>
    <div class="body-inner container-fluid price_wrapper df-spl-pull-left col-md-12 spl_main_content_box" id="spl_<?php echo $id; ?>" data-style="<?php echo $style; ?>" style="max-width:1200px;margin-left:auto;margin-right:auto; ">
...
<?php }
if($style=='style_7'){ ?>
    <div class="body-inner container-fluid price_wrapper df-spl-pull-left col-md-12 spl_main_content_box" id="spl_<?php echo $id; ?>" data-style="7" style="max-width:1200px;margin-left:auto;margin-right:auto; ">
...
<div class="body-inner container-fluid price_wrapper spl_main_content_box" id="spl_<?php echo $id; ?>" data-style="<?php echo $style; ?>" style="max-width:1200px;margin-left:auto;margin-right:auto;">
    <div class="style-8-container">
        ...
        <?php endif; ?>
        <nav class="df-spl-style8_cat_tab-container">
            <!-- Nav tabs -->
            <ul>
                <?php if($all_tab!='' && $toggle_all_tab==1){
                    ?>
...
<?php if(!empty($service_size)): ?>
 ...
 #spl_<?php echo $id; ?>.price_wrapper .style-8-title-container h3 {
...
<?php if($style == 'style_8'){ ?>
    :root {
        --df-spl-style8-pricetag-bg: <?php echo $price_color; ?>;
        --df-spl-style8-active-tab-bg: <?php echo $hover_color; ?>;
...
<?php if(!empty($title_font)): ?>
  ...
  #spl_<?php echo $id; ?>.price_wrapper .df-spl-style8_cat_tab-container ul li a,
  #spl_<?php echo $id; ?>.price_wrapper .style-8-pricetag-container .pricetag span,
...
<?php if(!empty($service_description_font)): ?>
    ...
    #spl_<?php echo $id; ?>.price_wrapper .style-8-title-container small {
...
<?php if(!empty($service_color)): ?>
  ...
  #spl_<?php echo $id; ?>.price_wrapper .style-8-title-container h3,
  #spl_<?php echo $id; ?>.price_wrapper .style-8-description{
...
#spl_<?php echo $id; ?>.price_wrapper .style-8-title-container h3:hover {
color: <?php echo $hover_color; ?> !important;
}
...
font-size:  <?php echo !empty($tab_description_font_size) ? $tab_description_font_size : 'inherit' ?>;
...
#spl_<?php echo $id; ?>.price_wrapper .df-spl-style8_cat_tab-container ul li:not(.active) a {
